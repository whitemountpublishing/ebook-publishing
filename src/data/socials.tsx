...
export const socials = [
  {
    url: 'https://www.linkedin.com/company/whitemount-publishing/',
    icon: (
  ...
  {
    url: 'https://www.facebook.com/WhitemountPublishing/',
    icon: (
      <svg viewBox='0 0 24 24' width='18' height='18' fill='currentColor'>
  ...
  {
    url: 'https://www.trustpilot.com/review/whitemountpublishing.com',
    icon: (
      <svg role='img' viewBox='0 0 24 24' width='18' height='18' fill='currentColor'>
...
export const contactMethods = [
  {
    label: 'Email',
    value: data.brand.contact.email,
    href: `mailto:${data.brand.contact.email}`,
    icon: <MailIcon />,
  },
  {
    label: 'Phone',
    value: data.brand.contact.phone,
    href: `tel:${data.brand.contact.phone.replace(/\s/g, '')}`,
    icon: <PhoneIcon />,
  },
];
